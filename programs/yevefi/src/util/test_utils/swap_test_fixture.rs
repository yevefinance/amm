...
use crate::state::{
    tick::*, tick_builder::TickBuilder, yevefi_builder::YevefiBuilder, TickArray, Yevefi,
};
use crate::state::{YevefiRewardInfo, NUM_REWARDS};
...
pub fn assert_swap(swap_update: &PostSwapUpdate, expect: &SwapTestExpectation) {
    ...
    assert_eq!(
        YevefiRewardInfo::to_reward_growths(&swap_update.next_reward_infos),
