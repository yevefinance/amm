...
use crate::{manager::swap_manager::PostSwapUpdate, state::Yevefi};

use super::{transfer_from_owner_to_vault_v2, transfer_from_vault_to_owner_v2};

#[allow(clippy::too_many_arguments)]
pub fn update_and_swap_yevefi_v2<'info>(
...
#[allow(clippy::too_many_arguments)]
pub fn update_and_two_hop_swap_yevefi_v2<'info>(
    // update
    swap_update_one: PostSwapUpdate,
    swap_update_two: PostSwapUpdate,
    // yevefi
    yevefi_one: &mut Account<'info, Yevefi>,
    yevefi_two: &mut Account<'info, Yevefi>,
    // direction
