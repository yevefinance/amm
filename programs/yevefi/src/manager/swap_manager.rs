...
use crate::{
    errors::ErrorCode,
    manager::{tick_manager::next_tick_cross_update, yevefi_manager::next_yevefi_reward_infos},
    math::*,
    state::*,
...
pub fn swap(
    ...
    if a_to_b && adjusted_sqrt_price_limit > yevefi.sqrt_price
        || !a_to_b && adjusted_sqrt_price_limit < yevefi.sqrt_price
    {
...
mod swap_liquidity_tests {
    use super::*;
    use crate::util::{create_yevefi_reward_infos, test_utils::swap_test_fixture::*};
    ...
    fn zero_l_across_tick_range_b_to_a() {
        let swap_test_info = SwapTestFixture::new(SwapTestFixtureInfo {
            ...
            reward_infos: create_yevefi_reward_infos(100, 10),
