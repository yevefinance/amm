use crate::{
    ...
    state::{Tick, TickUpdate, YevefiRewardInfo, NUM_REWARDS},
};
...
mod tick_manager_tests {
    ...
    use crate::{
        ...
        math::Q64_RESOLUTION,
        state::{tick_builder::TickBuilder, Tick, YevefiRewardInfo, NUM_REWARDS},
    };

    use super::next_reward_growths_inside;

    fn create_test_yevefi_reward_info(
    ...
    fn test_next_reward_growths_inside() {
        ...
        for test in [
            Test {
                ...
                tick_current_index: -200,
                reward_infos: [
                    create_test_yevefi_reward_info(1, 500, true),
                    create_test_yevefi_reward_info(1, 1000, true),
                    create_test_yevefi_reward_info(1, 70000, true),
                ],
            ...
            Test {
                ...
                reward_infos: [
                    create_test_yevefi_reward_info(1, 1000, true),
                    create_test_yevefi_reward_info(1, 2000, true),
                    create_test_yevefi_reward_info(1, 80000, true),
                ],
            ...
            Test {
                ...
                reward_infos: [
                    create_test_yevefi_reward_info(1, 1000, true),
                    create_test_yevefi_reward_info(1, 2000, false),
                    create_test_yevefi_reward_info(1, 80000, false),
                ],
    ...
    fn test_next_tick_modify_liquidity_update() {
        ...
        // Yevefi rewards re-used in the tests
        let reward_infos = [
            YevefiRewardInfo {
    ...
    fn test_next_tick_modify_liquidity_update_errors() {
        ...
        for test in [
            ...
            let err = next_tick_modify_liquidity_update(
                ...
                0,
                0,
                &[YevefiRewardInfo::default(); NUM_REWARDS],
                test.liquidity_delta,
                test.is_upper_tick,
            )
            .unwrap_err();
