...
mod data_layout_tests {
    ...
    #[test]
    fn test_yevefis_config_data_layout() {
        ...
        let mut config_data = [0u8; YevefisConfig::LEN];
        let mut offset = 0;
        config_data[offset..offset + 8].copy_from_slice(&YevefisConfig::discriminator());
        offset += 8;
        ...
        assert_eq!(offset, YevefisConfig::LEN);

        // deserialize
        let deserialized = YevefisConfig::try_deserialize(&mut config_data.as_ref()).unwrap();
