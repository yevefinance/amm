...
mod data_layout_tests {
    ...
    fn test_fee_tier_data_layout() {
        let fee_tier_yevefis_config = Pubkey::new_unique();
        ...
        offset += 8;
        fee_tier_data[offset..offset + 32].copy_from_slice(&fee_tier_yevefis_config.to_bytes());
        offset += 32;
        ...
        assert_eq!(fee_tier_yevefis_config, deserialized.yevefis_config);
