...
function openBundledPositionIx(program, params) {
    const { yevefi, bundledPositionPda, positionBundle, positionBundleTokenAccount, positionBundleAuthority, bundleIndex, tickLowerIndex, tickUpperIndex, funder, } = params;
