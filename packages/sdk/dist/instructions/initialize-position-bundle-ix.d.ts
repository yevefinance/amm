 ...
 */
export declare function initializePositionBundleIx(program: Program<Yevefi>, params: InitializePositionBundleParams): Instruction;
/**
 * Initializes a PositionBundle account.
 ...
 * @returns - Instruction to perform the action.
 */
export declare function initializePositionBundleWithMetadataIx(program: Program<Yevefi>, params: InitializePositionBundleParams & {
