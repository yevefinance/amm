...
/**
 * A selection of utility functions for the {@link YevefiRouter}.
 * @category Router
 */
export declare class RouterUtils {
     ...
     *
     * @param ctx The {@link YevefiContext} that represents the current execution environment
     ...
     */
    static selectFirstExecutableRoute(ctx: YevefiContext, orderedRoutes: TradeRoute[], opts: RouteSelectOptions): Promise<ExecutableRoute | null>;
    /**
