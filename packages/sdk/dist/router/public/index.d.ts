 ...
 * @param yevefi The address of the yevefi that this hop is trading through.
 ...
 * @param snapshot A snapshot of the yevefi condition when this hop was made
 */
...
/**
 * A snapshot of the yevefi condition when a trade hop was made.
 * @category Router
 */
...
/**
 * Convienience class to find routes through a set of Yevefis and execute a swap across them.
 * The router only supports up to 2-hop trades between pools and does not support arbitrage trades
 * between the same token.
 *
 * @category Router
 */
export interface YevefiRouter {
    /**
     ...
     * @param fetchOpts
     * {@link YevefiAccountFetchOptions} to configure the fetching of on-chain data.
     ...
     */
    findBestRoute(trade: Trade, opts?: Partial<RoutingOptions>, selectionOpts?: Partial<RouteSelectOptions>, fetchOpts?: YevefiAccountFetchOptions): Promise<ExecutableRoute | null>;
    /**
