...
import { type DecimalsMap, type PoolMap, type PriceCalculationData, type PriceMap, type TickArrayMap } from ".";
...
export declare class PriceModule {
     ...
     *
     * @param fetcher {@link YevefiAccountFetcherInterface}
     ...
     */
    static fetchTokenPricesByMints(fetcher: YevefiAccountFetcherInterface, mints: Address[], config?: import(".").GetPricesConfig, thresholdConfig?: import(".").GetPricesThresholdConfig, opts?: import("@orca-so/common-sdk").SimpleAccountFetchOptions, availableData?: Partial<PriceCalculationData>): Promise<PriceMap>;
    /**
     ...
     * @returns A map of token addresses to prices
     */
    static fetchTokenPricesByPools(fetcher: YevefiAccountFetcherInterface, pools: Address[], config?: import(".").GetPricesConfig, thresholdConfig?: import(".").GetPricesThresholdConfig, opts?: YevefiAccountFetchOptions): Promise<PriceMap>;
    /**
...
export declare class PriceModuleUtils {
     ...
     */
    static fetchPoolDataFromMints(fetcher: YevefiAccountFetcherInterface, mints: Address[], config?: import(".").GetPricesConfig, opts?: import("@orca-so/common-sdk").SimpleAccountFetchOptions): Promise<PoolMap>;
    /**
     ...
     */
    static fetchTickArraysForPools(fetcher: YevefiAccountFetcherInterface, pools: PoolMap, config?: import(".").GetPricesConfig, opts?: YevefiAccountFetchOptions): Promise<TickArrayMap>;
    /**
     ...
     */
    static fetchDecimalsForMints(fetcher: YevefiAccountFetcherInterface, mints: Address[], opts?: import("@orca-so/common-sdk").SimpleAccountFetchOptions): Promise<DecimalsMap>;
}
