 ...
 * @category Constants
 */
export declare const ORCA_YEVEFI_PROGRAM_ID: PublicKey;
/**
 * Orca's YevefisConfig PublicKey.
 * @category Constants
 */
export declare const ORCA_YEVEFIS_CONFIG: PublicKey;
/**
 ...
 * @category Constants
 */
export declare const YEVEFI_NFT_UPDATE_AUTH: PublicKey;
