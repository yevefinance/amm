...
export declare class PoolGraphBuilder {
     ...
     * @param cache - {@link YevefiAccountFetcherInterface} to use for fetching pool data
     * @returns A {@link PoolGraph} with the provided pools
     */
    static buildPoolGraphWithFetch(pools: Address[], fetcher: YevefiAccountFetcherInterface): Promise<PoolGraph>;
    /**
