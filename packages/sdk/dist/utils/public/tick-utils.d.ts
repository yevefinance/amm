...
import { type TickArrayData, type TickData } from "../../types/public";
/**
...
export declare class TickUtil {
     ...
     * @param tickSpacing The tickSpacing for the Yevefi that this tickArray belongs to
    ...
    /**
     * Check if the tick range is the full range of the Yevefi.
     * @param tickSpacing The tickSpacing for the Yevefi
     * @param tickLowerIndex The lower tick index of the range
     * @param tickUpperIndex The upper tick index of the range
     * @returns true if the range is the full range of the Yevefi, false otherwise.
     */
...
export declare class TickArrayUtil {
     ...
     * @param tickSpacing - Tick spacing for the yevefi
     * @param numOfTickArrays - The number of TickArray PDAs to generate
     * @param programId - Program Id of the yevefi for these tick-arrays
     * @param yevefiAddress - Address for the Yevefi for these tick-arrays
     * @returns TickArray PDAs for the sequence`
     */
    static getTickArrayPDAs(tick: number, tickSpacing: number, numOfTickArrays: number, programId: PublicKey, yevefiAddress: PublicKey, aToB: boolean): PDA[];
    /**
     ...
     * @param cache - {@link YevefiAccountFetcherInterface}
     ...
     */
    static getUninitializedArraysString(tickArrayAddrs: Address[], fetcher: YevefiAccountFetcherInterface, opts?: YevefiAccountFetchOptions): Promise<string | null>;
    static getUninitializedArraysPDAs(ticks: number[], programId: PublicKey, yevefiAddress: PublicKey, tickSpacing: number, fetcher: YevefiAccountFetcherInterface, opts: YevefiAccountFetchOptions): Promise<{
        startIndex: number;
        pda: PDA;
    }[]>;
    /**
     * Evaluate a list of tick-array data and return the array of indices which the tick-arrays are not initialized.
     * @param tickArrays - a list of TickArrayData or null objects from YevefiAccountCacheInterface.getTickArrays
