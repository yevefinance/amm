 ...
 * @category Network
 */
export type YevefiSupportedTypes =
	| YevefisConfigData
	| YevefiData
	| PositionData
	| TickArrayData
 ...
 * @category Network
 */
export const DEFAULT_YEVEFI_RETENTION_POLICY: ReadonlyMap<
	ParsableEntity<YevefiSupportedTypes>,
	number
> = new Map<ParsableEntity<YevefiSupportedTypes>, number>([]);
